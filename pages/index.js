...
function LinkActionButtons(props) {
  return (
    <a href={props.url} target={props.newtab ? "_blank" : ""} rel="noreferrer" className="text-gray-500 inline-block bg-gray-300 hover:bg-gray-600 filter drop-shadow-lg hover:text-gray-200 rounded font-semibold px-2 py-1 mt-2 mr-2 w-full md:w-5/6">
      {props.text}
    </a>
  )
}
    ...
    <div>
      ...
      <div className="px-10 min-h-screen bg-gray-700 py-6 flex flex-col justify-center sm:py-12">
        <div className="">
          ...
          <p className="text-2xl sm:text-4xl lg:text-7xl font-bold mb-1 text-gray-300 filter drop-shadow-2xl">Muhammad Isa Al Anshori</p>
      ...
      <div className="px-10 min-h-screen bg-gray-700 py-6 flex flex-col sm:flex-row-reverse justify-center sm:py-12">
          ...
          <div className="flex flex-col justify-center items-center w-full">
            <LinkActionButtons url={typeof window === "undefined" ? "" : window.location.origin} text="This Website"/>
            <LinkActionButtons url="/covid-id" newtab="1" text="Covid-ID"/>
          </div>
